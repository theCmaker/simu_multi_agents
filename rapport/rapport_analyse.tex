    ...
    \subsection{Dimension aléatoire}
      ...
      \begin{figure}[H]
        \begin{ganttchart}[vgrid,hgrid]{1}{12}
          ...
          \ganttbar{Specialisation de faction}{8}{8}
		  \ganttbar{Technologie}{9}{9}
		  \ganttbar{Systeme de negociation}{10}{10}
		  \ganttbar{Systeme d'espionage}{11}{11}
		  \ganttbar{création de faction dissidentes}{12}{12}
        \end{ganttchart}
